        ...
        <section className="pb-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col justify-center items-center mb-8 sm:mb-12 md:mb-16">
                    ...
                    <p className="max-w-lg justify-center text-center text-sm text-app-text-light mt-1">
                ...
                <div className="flex justify-center mt-8 sm:mt-10 md:mt-12">
                    <button
                        ...
                        className="px-4 sm:px-5 py-3 text-white bg-app-orange-dark font-semibold rounded-lg hover:bg-app-black transition-colors flex items-center gap-2 text-sm sm:text-base"
                    >
                        View All Products
