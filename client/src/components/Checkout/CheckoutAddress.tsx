    ...
    return (
        <div className="bg-white rounded-2xl p-6 animate-fade-in">
            ...
            {user?.addresses && user.addresses.length > 0 && (
                <div className="mb-6">
                    <h3 className="text-sm font-semibold text-app-orange mb-3">Saved Addresses</h3>
                    <div className="grid sm:grid-cols-2 gap-3">
                        {user.addresses.map((addr: any) => (
                            <div
                                ...
                                className={`p-4 rounded-xl border cursor-pointer transition-colors ${address.label === addr.label && address.address === addr.address ? "border-app-orange bg-app-cream" : "border-app-border hover:bg-app-cream"}`}
                            >
            ...
            <Link to="/addresses" className="mt-6 px-6 py-3 border hover:bg-app-orange-dark hover:text-white hover:border-none border-gray-600 text-gray-600 rounded-xl flex-center gap-2">
